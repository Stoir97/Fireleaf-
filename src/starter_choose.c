...
#if IS_FRLG
// Must match Oak's Lab scripts and VAR_STARTER_MON_FRLG.
#define GRASS_STARTER SPECIES_BULBASAUR
#define FIRE_STARTER  SPECIES_SQUIRTLE
#define WATER_STARTER SPECIES_CHARMANDER
#elif IS_HNS
